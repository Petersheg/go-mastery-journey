...
/* Pointer receivers
	...
	Try removing the * from the declaration of the Scale function on line 32 and observe how the program's behavior changes.
...
func Calc() {
	...
	fmt.Println("From Method", v.Abs())
}

/* Pointers and functions
	Here we see the Abs and Scale methods rewritten as functions.

	Again, try removing the * from line 53. 
*/
...
func Calc2() {
	...
	Scale2(&v, 10)
	fmt.Println("From Function", v.Abs())
}
...
/* Methods and pointer indirection
	...
	That is, as a convenience, Go interprets the statement 
...
func Calc4() {
	v := Vertex{X: 2, Y: 4}
	fmt.Println("Method accessing ", v.Abs())
	fmt.Println(Abs2(v))
